...
import { BookOpen, Star, Heart, MapPin, Sparkles, Quote, Users } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white text-gray-800">
      ...
      <section className="relative py-24 px-6 bg-gradient-to-br from-orange-100 via-amber-50 to-green-50 overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('/spiral-pattern.svg')] bg-center bg-repeat"></div>
      ...
      <section id="full-bio" className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto prose prose-lg prose-orange">
          ...
          <p>
            Settling beneath a neem tree in the dilapidated Dwarkamai mosque, Sai Baba lit an ever-burning dhuni (sacred fire) and swept the courtyard daily, symbolizing both his humility and spiritual purity. From this simple seat, he shared boundless compassion, drawing seekers from far and wide.
          </p>

          <h3 className="text-2xl font-medium text-orange-700 mb-4">Teachings of Unity & Compassion</h3>
          <p>
            Central to his message were <strong>Shraddha</strong> (faith) and <strong>Saburi</strong> (patience). Baba urged devotees to face life’s challenges with steadfast devotion. He quoted scriptures from both the <em>Bhagavad Gita</em> and the <em>Quran</em>, urging all to see the Divine within every soul.
          </p>
          ...
          <h3 className="text-2xl font-medium text-orange-700 mb-4">Miracles and Grace</h3>
          <ul className="list-disc list-inside space-y-3">
            <li><strong>Healing Touch:</strong> Chronic ailments vanished, and lost limbs restored through earnest prayers and the sacred <strong>Udi</strong> from the Dwarkamai fire.</li>
            <li><strong>Inexhaustible Charity:</strong> Single baskets of food fed hundreds during famine, demonstrating infinite compassion.</li>
            <li><strong>Nature’s Mastery:</strong> Storms calmed with a raised hand, guiding the elements by divine authority.</li>
            <li><strong>Miraculous Harvests:</strong> Blessed grains yielded abundant crops, rescuing families from ruin.</li>
          </ul>
          <hr className="my-8 border-amber-300" />

          <h3 className="text-2xl font-medium text-orange-700 mb-4">Daily Rituals & Darshan</h3>
          <p>
            Each dawn, Baba swept the courtyard and lit the dhuni, teaching that cleanliness and inner purity go hand-in-hand. From midday Darshan to evening discourses, his presence offered solace. Communal <em>Langar</em> broke social barriers, uniting all in a single circle of spiritual family.
          </p>

          <h3 className="text-2xl font-medium text-orange-700 mb-4">Final Years & Mahasamadhi</h3>
          <p>
            On October 15, 1918, during Vijayadashami, Sai Baba entered Mahasamadhi. Devotees chanted and wept, yet his tomb at Samadhi Mandir became a vibrant site of eternal blessings.
          </p>

          <h3 className="text-2xl font-medium text-orange-700 mb-4">Enduring Legacy</h3>
          <p>
            Globally, temples honor Sai Baba’s message: <strong>“Love All, Help Ever, Hurt Never.”</strong> His teachings foster interfaith harmony, reminding us that the world is one family (<em>Vasudhaiva Kutumbakam</em>).
          </p>
